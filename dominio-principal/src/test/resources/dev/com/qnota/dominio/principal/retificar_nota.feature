Feature: Retificar Nota com Justificativa
  ...
  # RN-39 (atualizado): retificação permitida com simulado EM_EDICAO ou FINALIZADO
  ...
  Scenario: Retificar nota em simulado finalizado (sucesso - RN-39 atualizado)
    Given um simulado "finalizado" com nota original 5.0
    When o coordenador retifica a nota para 6.0 com justificativa "Após revisão detalhada, pontos foram corretamente ajustados."
    Then o sistema confirma retificação com nova versão armazenada
    And a justificativa registra valores 5.0 -> 6.0
