Feature: Gerenciar alunos
  ...
  Scenario: Bloquear alteração de turma quando há simulados finalizados (falha - RN-57)
    ...
    Then o sistema rejeita a transferência em alunos
    And o sistema informa em alunos que "não é permitido alterar a turma do aluno com simulados finalizados"
  ...
  Scenario: Bloquear exclusão de aluno com notas (falha - RN-04)
    ...
    And o sistema informa em alunos que "o aluno possui vínculos com simulados/nota"
  ...
  Scenario: Bloquear inativação com notas pendentes (falha - RN-67)
    ...
    And o sistema informa em alunos que "existem notas pendentes de lançamento"
  ...
  Scenario: Bloquear cadastro sem responsáveis (falha - RN-19)
    ...
    Then o sistema rejeita o cadastro em alunos
    And o sistema informa em alunos que "Aluno deve ter ao menos um responsável"
  ...
  Scenario: Bloquear cadastro sem nome do aluno (falha - NOT NULL)
    ...
    Then o sistema rejeita o cadastro em alunos
    And o sistema informa em alunos que "'nome' não pode ser vazio"
  ...
  Scenario: Bloquear cadastro sem data de nascimento (falha - NOT NULL)
    ...
    When um coordenador tenta cadastrar o "aluno" na turma "7A" com responsáveis válidos
    Then o sistema rejeita o cadastro em alunos
    And o sistema informa em alunos que "'dataNascimento' não pode ser nula"

  Scenario: Bloquear cadastro sem turma (falha - NOT NULL)
    Given um "aluno" "não está" registrado e "sem turma"
    When um coordenador tenta cadastrar o "aluno" na turma "7A" com responsáveis válidos
    Then o sistema rejeita o cadastro em alunos
    And o sistema informa em alunos que "'turma' não pode ser nula"
