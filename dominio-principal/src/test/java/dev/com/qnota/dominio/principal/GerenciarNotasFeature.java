...
public class GerenciarNotasFeature {
    ...
    private final CalculoRankingStrategy mediaPonderada = new CalculoRankingMediaPonderada(notaServico);
    private final CalculoRankingStrategy mediaAritmetica = new CalculoRankingMediaAritmetica();
    private final RankingServico rankingServico = new RankingServico(repo, repo, repo, mediaPonderada, mediaAritmetica);
