...
public class GerenciarTurmasFeature {
    ...
    public void turma_registrada_possui_vinculos(String estado, String possui) {
        ...
        if ("possui".equalsIgnoreCase(possui)) {
            ...
            repo.salvar(new dev.com.qnota.dominio.principal.aluno.Aluno(alunoId, "Aluno Teste", java.time.LocalDate.of(2012, 1, 1), true, currentTurmaId, responsaveis, principal));
        }
    }
