...
public class RetificarNotaFeature {
    ...
    public void um_simulado_com_nota_original(String estado, double valor) {
        ...
        notaSrv = new NotaServico(repo, ranking, repo);
        ...
        // Cria o simulado inicialmente EM_EDICAO para poder lançar a nota via serviço
        var sim = novoSimulado(Simulado.Status.EM_EDICAO);
        repo.salvar(sim);
    ...
    public void justificativa_registra_valores(double anterior, double corrigida) {
        ...
        assertFalse(js.isEmpty(), "RN-37/38: era esperado registro de justificativa");
